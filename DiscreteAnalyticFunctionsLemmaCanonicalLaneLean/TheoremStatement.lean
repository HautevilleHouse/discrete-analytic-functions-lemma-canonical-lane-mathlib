import DiscreteAnalyticFunctionsLemmaCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "discrete analytic functions lemma: bridge and gate closure over the admitted discrete harmonic class with carried classical boundary",
